...
<nav class="am-g am-g-fixed blog-fixed blog-nav">
    ...
    <div class="am-collapse am-topbar-collapse" id="blog-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav">
            ...
            <li><a href="lw-article.html">个人中心</a></li>
            <li><a href="lw-img.html">热门专题</a></li>
            <li><a href="lw-article-fullwidth.html">热门文章</a></li>
    ...
    <div class="am-u-sm-12">
        <article class="am-article blog-article-p">
            <div class="am-article-hd">
                <h1 class="am-article-title blog-text-center">可爱的妞妞</h1>
                <p class="am-article-meta blog-text-center">
                    <span><a href="#" class="blog-color">纪实 &nbsp;</a></span>-
                    <span><a href="#">@老张&nbsp;</a></span>-
                    <span><a href="#">2017/10/7</a></span>
                </p>
            </div>
            <div class="am-article-bd">
                <img src="assets/img/f17.jpg" alt="" class="blog-entry-img blog-article-margin">
