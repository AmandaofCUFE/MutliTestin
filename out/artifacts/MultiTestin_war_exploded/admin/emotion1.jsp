...
<div  class="am-g am-g-fixed blog-fixed blog-content">
    ...
    <p><button type="button" class="am-btn am-btn-secondary am-round" onclick="addArticle()">提交</button></p>

    <table id = "uploadArticleData" name = "uploadArticleData" class="am-table am-table-bordered am-table-centered">
        <thead>
        <tr>
            <th>文章题目</th>
            <th>作者</th>
    ...
    function addArticle() {
        $.ajax({
            ...
            success: function (data) {
                ...
                var json = eval(data);
                console.log(json)
                $('#uploadArticleData tbody').after("<tr><td>"+json.articleTitle+"</td><td>&nbsp;&nbsp;"+json.articleAuthor+"</td><td>&nbsp;&nbsp;"+json.articleUrl+"</td></tr>\n")
