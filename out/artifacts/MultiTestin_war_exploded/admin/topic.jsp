        ...
        <ul class="am-slides">
            ...
            <li>
                ...
                <div class="blog-slider-desc am-slider-desc ">
                    <div class="blog-text-center blog-slider-con">
                        <span><a href="readingArticle.jsp" class="blog-color">Reading This Topic &nbsp;</a></span>
                        <h1 class="blog-h-margin"><a href="readingArticle.jsp">娱乐</a></h1>
            ...
            <li>
                ...
                <div class="blog-slider-desc am-slider-desc ">
                    <div class="blog-text-center blog-slider-con">
                        <span><a href="readingArticle.jsp" class="blog-color">Reading This Topic &nbsp;</a></span>
                        <h1 class="blog-h-margin"><a href="readingArticle.jsp">科技</a></h1>
                        <p>那时候刚好下着雨，柏油路面湿冷冷的，还闪烁着青、黄、红颜色的灯火。
                        </p>
                        <span class="blog-bor">2015/10/9</span>
                        <br><br><br><br><br><br><br>
            ...
            <li>
                ...
                <div class="blog-slider-desc am-slider-desc ">
                    <div class="blog-text-center blog-slider-con">
                        <span><a href="readingArticle.jsp" class="blog-color">Reading This Topic &nbsp;</a></span>
                        <h1 class="blog-h-margin"><a href="readingArticle.jsp">人生</a></h1>
                        <p>那时候刚好下着雨，柏油路面湿冷冷的，还闪烁着青、黄、红颜色的灯火。
                        </p>
                        <span class="blog-bor">2015/10/9</span>
                        <br><br><br><br><br><br><br>
    ...
    <div class="am-u-md-12 am-u-sm-12">
        ...
        <article class="am-g blog-entry-article">
            ...
            <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                ...
                <h1><a href="readingArticle.jsp">题目：娱乐圈又发生了什么事情哦</a></h1>
